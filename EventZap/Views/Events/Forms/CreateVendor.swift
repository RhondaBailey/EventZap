...
struct CreateVendor: View {
        ...
        NavigationView {
            Form {
                ...
                HStack {
                    Text("Description")
                    Spacer()
                    TextField("", text: $vendorDescription)
                        .textFieldStyle(.roundedBorder)
                        .frame(width: 200)
                }
                HStack {
    ...
    func saveRecordToCloudKit() {
        ...
        record["productLine"] = productLine as CKRecordValue
        record["description"] = vendorDescription as CKRecordValue
        record["website"] = website as CKRecordValue
        record["phone"] = phone as CKRecordValue
        record["vendorId"] = vendorID  as CKRecordValue
...
/*struct CreateVendor_Previews: PreviewProvider {
